...
```bash
node --experimental-loader @boost/module/loader ./path/to/entry-point.mjs
```
...
The TypeScript only ESM loader can be referenced with `@boost/module/loader-typescript`.
