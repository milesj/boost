...
the 1st being that [`Plugin`][plugin] extends from [`Contract`](./common/contract.md), which allows
the plugin to inherit options through its constructor. This automatically happens when loading
plugins from a configuration file.
