...
[much more](#advanced)! It is _not_ a command line interface or application but provides the
...
[counters](#counter-options) (numeric options with
[`count`](/api/args/interface/SingleOption#count)), otherwise an error is thrown.
