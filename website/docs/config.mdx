...
a blueprint for the structure of our config file (using [optimal](./common/contract.md)). This class
will fulfill multiple roles: managing, finding, loading, and processing of files.
