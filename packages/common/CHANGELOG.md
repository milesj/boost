...
- Require TypeScript v5. ([a49d2ea](https://github.com/milesj/boost/commit/a49d2ea))
...
- **[pretty-ms]** Update to v8. ([9520ba1](https://github.com/milesj/boost/commit/9520ba1))
...
- **[resolve]** Update to latest. ([1391f04](https://github.com/milesj/boost/commit/1391f04))
- **[yaml]** Update to v2.1. ([f359e71](https://github.com/milesj/boost/commit/f359e71))
